...
const StepCard: React.FC<StepCardProps> = ({ step, icon: Icon, title, desc }) => (
  <div className="bg-[#1D4ED8] text-white border-2 md:border-4 border-white shadow-[4px_4px_0px_0px_#ffffff] md:shadow-[8px_8px_0px_0px_#ffffff] transform hover:translate-x-1 md:hover:translate-x-2 hover:translate-y-1 md:hover:translate-y-2 hover:shadow-[2px_2px_0px_0px_#ffffff] md:hover:shadow-[4px_4px_0px_0px_#ffffff] transition-all">
    <div className="p-4 md:p-8 text-center">
      <div className="w-12 h-12 md:w-16 md:h-16 bg-white text-[#1D4ED8] border-2 md:border-4 border-black flex items-center justify-center mx-auto mb-3 md:mb-4 transform rotate-3 shadow-[2px_2px_0px_0px_#000000] md:shadow-[4px_4px_0px_0px_#000000]">
